...
class Movie(models.Model):
    movieName = models.CharField("Название фильма", max_length=255)
    ...
    isRecommended = models.BooleanField("Рекомендуется", default=False, null=True, blank=True)
    rating = models.FloatField("Рейтинг",default=1.0, null=True, blank=True)
